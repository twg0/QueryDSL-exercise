...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1586644966L;
    ...
    //inherited
    public final ListPath<hello.test.querydsl.domain.Category, hello.test.querydsl.domain.QCategory> categories = _super.categories;
